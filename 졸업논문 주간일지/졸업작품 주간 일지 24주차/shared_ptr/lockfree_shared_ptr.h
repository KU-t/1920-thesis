...
namespace LFSP {
	...
	public:
		...
		control_block<Tp>* weak_add_ref() noexcept
		{
			int pred_value;
	...
	public:
		...
		control_block<Tp>* add_ref_copy() const
		{
	...
	private:
		...
		control_block<Tp>* weak_add_ref() const
		{
			control_block<Tp>* curr_ctr;
			control_block<Tp>* ret_ctr;
