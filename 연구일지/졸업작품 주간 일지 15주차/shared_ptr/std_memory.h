...
inline
	_FwdIt _Uninitialized_copy_unchecked
	(_InIt _First, const _InIt _Last, const _FwdIt _Dest, std::_General_ptr_iterator_tag)
...
inline
	_FwdIt _Uninitialized_copy_unchecked
	(const _InIt _First, const _InIt _Last, const _FwdIt _Dest, std::_Really_trivial_ptr_iterator_tag)
...
inline
	...
	(const _InIt _First, const _InIt _Last, _FwdIt _Dest)
{	// copy [_First, _Last) to raw [_Dest, ...)
	_Adl_verify_range(_First, _Last);
	const auto _UFirst = _Get_unwrapped(_First);
	const auto _ULast = _Get_unwrapped(_Last);
	const auto _UDest = _Get_unwrapped_n(_Dest, std::_Idl_distance<_InIt>(_UFirst, _ULast));
	_Seek_wrapped(_Dest,
...
{	// copy [_First, _Last) to raw [_Dest, ...)
	return (_STD uninitialized_copy(_First, _Last, std::_Array_iterator<_OutTy, _OutSize>(_Dest))._Unwrapped());
}
...
template<class _InIt,
	...
	_FwdIt _Uninitialized_copy_n_unchecked2(_InIt _First, _Diff _Count,
		const _FwdIt _Dest, std::_General_ptr_iterator_tag)
...
template<class _InIt,
	...
	_FwdIt _Uninitialized_copy_n_unchecked2(const _InIt _First, const _Diff _Count,
		const _FwdIt _Dest, std::_Really_trivial_ptr_iterator_tag)
...
template<class _InIt,
	...
	class _FwdIt> inline
	pair<_InIt, _FwdIt> _Uninitialized_move_n_unchecked1(_InIt _First, _Diff _Count,
		_FwdIt _Dest, std::_Really_trivial_ptr_iterator_tag)
...
template<class _FwdIt,
	class _Tval> inline
	void _Uninitialized_fill_unchecked(const _FwdIt _First, const _FwdIt _Last, const _Tval& _Val, std::false_type)
...
template<class _FwdIt,
	class _Tval> inline
	void _Uninitialized_fill_unchecked(const _FwdIt _First, const _FwdIt _Last, const _Tval& _Val, std::true_type)
...
template<class _FwdIt,
	class _Diff,
	class _Tval> inline
	_FwdIt _Uninitialized_fill_n_unchecked1(const _FwdIt _First, _Diff _Count, const _Tval& _Val, std::false_type)
...
template<class _FwdIt,
	class _Diff,
	class _Tval> inline
	_FwdIt _Uninitialized_fill_n_unchecked1(const _FwdIt _First, const _Diff _Count, const _Tval& _Val, std::true_type)
...
template<class _FwdIt,
	class _Diff> inline
	_FwdIt _Destroy_n1(_FwdIt _First, _Diff _Count, std::false_type)
...
template<class _FwdIt,
	class _Diff> inline
	_FwdIt _Destroy_n1(const _FwdIt _First, const _Diff _Count, std::true_type)
...
template<class _FwdIt> inline
void _Uninitialized_default_construct_unchecked(const _FwdIt _First, const _FwdIt _Last, std::false_type)
...
template<class _FwdIt> inline
void _Uninitialized_default_construct_unchecked(_FwdIt, _FwdIt, std::true_type)
...
template<class _FwdIt,
	class _Diff> inline
	_FwdIt _Uninitialized_default_construct_n_unchecked(const _FwdIt _First, _Diff _Count, std::false_type)
...
template<class _FwdIt,
	class _Diff> inline
	_FwdIt _Uninitialized_default_construct_n_unchecked(const _FwdIt _First, const _Diff _Count, std::true_type)
...
template<class _FwdIt> inline
void _Uninitialized_value_construct_unchecked(const _FwdIt _First, const _FwdIt _Last, std::false_type)
...
template<class _FwdIt> inline
void _Uninitialized_value_construct_unchecked(const _FwdIt _First, const _FwdIt _Last, std::true_type)
...
template<class _FwdIt,
	class _Diff> inline
	_FwdIt _Uninitialized_value_construct_n_unchecked1(const _FwdIt _First, _Diff _Count, std::false_type)
...
template<class _FwdIt,
	class _Diff> inline
	_FwdIt _Uninitialized_value_construct_n_unchecked1(const _FwdIt _First, const _Diff _Count, std::true_type)
...
{	// std::exception type for invalid use of expired weak_ptr object
public:
...
public:
	_Ref_count_resource(_Resource _Px, _Dx _Dt)
		: _Ref_count_base(), _Mypair(std::_One_then_variadic_args_t(), _STD move(_Dt), _Px)
	{	// construct
	}
...
private:
	...
	std::_Compressed_pair<_Dx, _Resource> _Mypair;
};
...
public:
	_Ref_count_resource_alloc(_Resource _Px, _Dx _Dt, const _Alloc& _Ax)
		: _Ref_count_base(), _Mypair(std::_One_then_variadic_args_t(), _STD move(_Dt),
			std::_One_then_variadic_args_t(), _Ax, _Px)
	{	// construct
	}
...
private:
	...
	std::_Compressed_pair<_Dx, std::_Compressed_pair<_Myalty, _Resource>> _Mypair;
};
...
template<class _Other,
	class _Yty>
	void _Enable_shared_from_this1(const shared_ptr<_Other>& _This, _Yty * _Ptr, std::true_type)
...
template<class _Other,
	class _Yty>
	void _Enable_shared_from_this1(const shared_ptr<_Other>&, _Yty *, std::false_type)
...
{};
template<class _Yty>
struct _Can_scalar_delete<_Yty, std::void_t<decltype(delete _STD declval<_Yty *>())>>
	: std::true_type
{};
...
{};
template<class _Yty>
struct _Can_array_delete<_Yty, std::void_t<decltype(delete[] _STD declval<_Yty *>())>>
	: std::true_type
{};
...
template<class _Fx,
	class _Arg>
	struct _Can_call_function_object<_Fx, _Arg, std::void_t<decltype(_STD declval<_Fx>()(_STD declval<_Arg>()))>>
	: std::true_type
{};
...
public:
	...
	template<class _Ux,
		std::enable_if_t<std::conjunction_v<std::conditional_t<std::is_array_v<_Ty>, _Can_array_delete<_Ux>, _Can_scalar_delete<_Ux>>,
	...
	template<class _Ty2,
		std::enable_if_t<_SP_pointer_compatible<_Ty2, _Ty>::value, int> = 0>
...
private:
	template<class _Other,
		class _Yty>
		friend void _Enable_shared_from_this1(const shared_ptr<_Other>& _This, _Yty * _Ptr, std::true_type);
...
{	// default deleter for unique_ptr to array of unknown size
	...
	template<class _Uty,
		std::enable_if_t<std::is_convertible_v<_Uty(*)[], _Ty(*)[]>, int> = 0>
...
public:
	...
	std::_Compressed_pair<_Dx, pointer> _Mypair;
};

template<class _Dx2>
using _Unique_ptr_enable_default_t = std::enable_if_t<std::conjunction_v<std::negation<std::is_pointer<_Dx2>>,
	std::is_default_constructible<_Dx2>>, int>;
...
public:
	...
	template<class _Dx2 = _Dx,
		std::enable_if_t<std::is_constructible_v<_Dx2, const _Dx2&>, int> = 0>
	...
	template<class _Dx2 = _Dx,
		std::enable_if_t<std::conjunction_v<std::negation<std::is_reference<_Dx2>>,
		std::is_constructible<_Dx2, _Dx2>>, int> = 0>
	...
	template<class _Dx2 = _Dx,
		...
		std::is_constructible<_Dx2, std::remove_reference_t<_Dx2>>>, int> = 0>
	...
	template<class _Ty2,
		...
		std::conditional_t<std::is_reference_v<_Dx>, std::is_same<_Dx2, _Dx>, std::is_convertible<_Dx2, _Dx>>
	>, int> = 0>
...
#if _HAS_AUTO_PTR_ETC
	template<class _Ty2,
		std::enable_if_t<std::conjunction_v<std::is_convertible<_Ty2 *, _Ty *>,
		std::is_same<_Dx, default_delete<_Ty>>>, int> = 0>
...
public:
	...
	template<class _Uty,
		class _Dx2 = _Dx,
		std::enable_if_t<is_constructible_v<_Dx2, const _Dx2&>, int> = 0,
		class = _Enable_ctor_reset<_Uty>>
	...
	template<class _Uty,
		class _Dx2 = _Dx,
		std::enable_if_t<conjunction_v<negation<is_reference<_Dx2>>,
	...
	template<class _Uty,
		class _Dx2 = _Dx,
		std::enable_if_t<conjunction_v<is_reference<_Dx2>,
	...
	template<class _Uty,
		...
		using _Enable_conversion = std::enable_if_t<conjunction_v<
		is_array<_Uty>,
	...
	template<class _Uty,
		class = _Enable_ctor_reset<_Uty, std::false_type>>
...
template<class _Ty,
	class... _Types,
	std::enable_if_t<std::extent_v<_Ty> != 0, int> = 0>
...
template<class _Ty,
	class _Dx,
	std::enable_if_t<std::_Is_swappable<_Dx>::value, int> = 0>
...
template<class _OutTy,
	class _PxTy>
	struct _Can_stream_unique_ptr<_OutTy, _PxTy, std::void_t<
...
template<class _Elem,
	...
	class _Yty,
	class _Dx,
	std::enable_if_t<_Can_stream_unique_ptr<std::basic_ostream<_Elem, _Traits>&, const unique_ptr<_Yty, _Dx>&>::value, int> = 0>
	std::basic_ostream<_Elem, _Traits>& operator<<(std::basic_ostream<_Elem, _Traits>& _Out, const unique_ptr<_Yty, _Dx>& _Px)
{	// write contained pointer to stream
	_Out << _Px.get();
	return (_Out);
}
...
template<class _Ty,
	class _Dx>
	struct std::hash<unique_ptr<_Ty, _Dx>>
...
template<class _Ty>
struct std::hash<shared_ptr<_Ty>>
{	// hash functor
...
///* SPIN LOCKS */
//_EXTERN_C
//_CRTIMP2_PURE void __cdecl std::_Lock_shared_ptr_spin_lock();
//_CRTIMP2_PURE void __cdecl std::_Unlock_shared_ptr_spin_lock();
//_END_EXTERN_C
//
//// WRAP SPIN-LOCK
