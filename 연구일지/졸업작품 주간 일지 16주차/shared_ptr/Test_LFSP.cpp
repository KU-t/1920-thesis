...
int main() {
	...
	{	//
		...
		//
	{	//
		//// 3.make_shared<enable_from_T> Release Error
	...
	{	//
		...
		//
	{	//
		//// 6. shared_ptr(shared_ptr<enable_from_T>)	Release Error
		//std::shared_ptr<stdTEST> ptr = std::make_shared<stdTEST>(1, 10);
	...
	{	//
		...
		//
	{	//
		//// 9. shared_ptr(weak_ptr<enable_from_T>) Release Error
		//std::shared_ptr<stdTEST> ptr = std::make_shared<stdTEST>(1, 10);
	...
	{	//
		//
		//// 11. shared_ptr = shared_ptr<T>	Release Error
		//std::shared_ptr<TEST> ptr = std::make_shared<TEST>(1, 10);
	...
	{	
		//// 12. shared_ptr = shared_ptr<enable_from_T>	Release Error
		//std::shared_ptr<stdTEST> ptr = std::make_shared<stdTEST>(1, 10);
	...
	{	
		//// 13. operator* & operator->	Release Error
		//std::shared_ptr<stdTEST> ptr = std::make_shared<stdTEST>(1, 10);
		//ptr->info();
		//(*ptr).info();
		//LFSP::shared_ptr<lfspTEST> _ptr = LFSP::make_shared<lfspTEST>(1, 10);
	...
	{	
		//// 14. operator== & operator!=	Release Error
		//std::shared_ptr<stdTEST> ptr = std::make_shared<stdTEST>(1, 10);
		//std::shared_ptr<stdTEST> ptr_c(ptr);
		//std::shared_ptr<stdTEST> ptr_ = std::make_shared<stdTEST>(10, 100);
	...
	{	//
		...
		//
	{	//
		//// 20. weak_ptr(shared_ptr<enable_from_T>)	Release Error
		//std::shared_ptr<stdTEST> ptr = std::make_shared<stdTEST>(1, 10);
	...
	{	//
		//
		//// 23. weak_ptr(weak_ptr<enable_from_T>)	Release Error
		//std::shared_ptr<stdTEST> ptr = std::make_shared<stdTEST>(1, 10);
		//std::weak_ptr<stdTEST> ptr_c(ptr);
	...
	{	//
		...
		//
	{	//
		//// 26. weak_ptr = shaerd_ptr<enable_from_T>	Release Error
		//std::shared_ptr<stdTEST> ptr = std::make_shared<stdTEST>(1, 10);
