...
inline void _Sp_counted_base::_M_add_ref_lock()
	...
	public:
		...
		template<typename _Ptr>
		__shared_count(_Ptr __p, /* is_array = */ true_type) : __shared_count(__p, __sp_array_delete{}, allocator<void>()) { }
...
#define __cpp_lib_shared_ptr_arrays 201611L
	...
	private:
		...
		using _UniqCompatible = typename enable_if<__and_<__sp_compatible_with<_Yp*, _Tp*>, is_convertible<_Ptr, element_type*>>::value, _Res>::type;
...
#pragma GCC diagnostic pop
	...
	private:
		...
		template<typename _Yp>
		using __esft_base_t = decltype(__enable_shared_from_this_base(std::declval<const __shared_count<_Lp>&>(), std::declval<_Yp*>()));
