...
/*
	...
	std::cout << "\nLFSP::shared_ptr(lock-free, NonHp) \t";
	...
	for (int num_thread = 1; num_thread <= number_of_threads; num_thread *= 2) {
		...
		ave_HPLFSP[return_array(num_thread)] += exec_ms;
	...
	std::cout << "LFSP::shared_ptr(lock-free,NonHp) \t";
	for (int num_thread = 1; num_thread <= number_of_threads; num_thread *= 2)
		std::cout << ave_LFSP[return_array(num_thread)] / Try_test << "ms\t\t";
	std::cout << std::endl;

	std::cout << "LFSP::shared_ptr(lock-free,Hp) \t";
	for (int num_thread = 1; num_thread <= number_of_threads; num_thread *= 2)
		std::cout << ave_HPLFSP[return_array(num_thread)] / Try_test << "ms\t\t";
	std::cout << std::endl;
